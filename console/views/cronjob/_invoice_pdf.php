  ...
  <div class="main-section">
   <div class="header-sec">
	 ...
	 <div class="left">
		...
		if( $companyModel->company_logo !=""){ ?><?php 
		echo Html::img($url.'/uploads/thumb/'.$companyModel->company_logo, ['alt' => 'Company Logo', "height"=>'100px', 'width'=>'200px']); ?> <?php } ?>
	 </div>
	 <div class="right">
 ...
 <div class="section2">
  ...
  <?php
		...
		//foreach($orderItems as $key=>$itemData ) { 
			...
			$productVatPercentage	= $productModel->getProductVat($sellerSKU, $user_id);
		...
		<tr>
			...
			<td style="text-align:left"><?php echo $amazonOrderModel->product_name;?></td>
...
<div class="section3">
 ...
 <div class="right-colm">
  ...
  <tr>
   ...
   <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","VAT Amount");?> <?php if($showDoulCurrency):?> / ДДС <?php endif;?> <?php echo $vatPer;?>%</td>
