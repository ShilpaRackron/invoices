...
<div class="card-body">
              <form>
<div class="row">
				<div class="col-lg-12 head"><h2>Import orders</h2></div>
				<div class="col-lg-8">
                  <div class="form-group">
                    <label class="form-control-label">Select Import Date:</label>
		...
		<p>Select Maximum one month range.</p>
                   ...
                   <div class="col-lg-4">
					 <label class="form-control-label">&nbsp;</label>
                      <button type="button" class="btn btn-danger btn-block" id="column_selection">Import Invoice Request</button>
                    </div>
                </div>
<?php
...
?>
<div class="row">
				  <div class="col-lg-12 head"><h2>send invoice email</h2></div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label">Email Send to : </label>
						<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>
                        <input id="emails" class="form-control form-control-alternative" value="Email id " type="text">
                      </div>
                    </div>
					 <div class="col-lg-4">
                      <div class="form-group">
	  ...
	  <?php		 
		...
		?>
					 ...
					 <div class="col-lg-4">
					 <label class="form-control-label">&nbsp;</label>
                      <button type="button" class="btn btn-primary btn-block" data-toggle="collapse" data-target="#collapseExample">Select Columns</button>
                    </div>
					</div>
					<div class="row">
				  <div class="col-lg-12 collapse" id="collapseExample">
				    <h4><input type="checkbox" class="check" id="selectall"> Select All</h4>
                   <ul class="checkbx-colm">
...
<div class="amazon-orders-search">
	...
	<div class="row">
				   <div class="col-lg-12 head"><h2>order search</h2></div>
                    <div class="col-lg-4">
                      <div class="form-group " style="margin-top:25px;">
                        <label class="" >Purchase Date Range</label> 
						<!--<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>-->
		 ...
		 echo DateRangePicker::widget([
			...
			?>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"></label>											
                        <?= $form->field($model, 'year')->dropDownList($yearsArray, ['prompt'=>'*'])->label(); ?>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"></label>
						<!--<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>--->
                         <?= $form->field($model, 'month')->dropDownList($month, ['prompt'=>'*'])->label(); ?>	
                      </div>
                    </div>
					</div>
					<div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"></label>
						<!--<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>--->
                        <?= $form->field($model, 'country_code')->dropDownList($countries, ['prompt'=>'*'])->label(); ?>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"></label>
						<!--<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>--->
                        <?= $form->field($model, 'fulfillment_center_id')->dropDownList($warehoueData, ['prompt'=>'*'])->label(); ?>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"></label>
						<!--<i class="fas fa-question-circle" data-toggle="tooltip" data-placement="top" title="Tooltip"></i>--->
                         <?= $form->field($model, 'sales_channel')->dropDownList($sales_channel, ['prompt'=>'*'])->label(); ?>
                      </div>
                    </div>
					</div>
					<div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        <?= $form->field($model, 'invoice_number')->textInput(['placeholder' => "Invoice No"])->label(false); ?>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                       <?= $form->field($model, 'buyer_name')->textInput(['placeholder' => "Customer"])->label(false); ?>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                         <?= $form->field($model, 'amazon_order_id')->textInput(['placeholder' => "Amazon Order Id"])->label(false); ?>
                      </div>
                    </div>
					<!--<div class="col-lg-12 text-center"><a href="#!" class="btn btn-danger">Search</a> <a href="#!" class="btn btn-primary">Reset</a></div>--->
                  </div>
	...
	<div class="row" style="margin-top: 20px;">
			<div class="col-lg-12 text-center">
				...
				<?= Html::Button(Yii::t('app', 'Reset'), ['class' => 'btn btn-default reset btn btn-primary']) ?>
			</div>
		</div>
