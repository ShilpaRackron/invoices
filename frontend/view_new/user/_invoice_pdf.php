...
.header-sec .right td{ border-bottom:1px solid #ddd; padding:5px; font-size:11px; color:#5f5f5f;}
...
<div id="wrapper">
 <div class="wrap">
  ...
  <tr>
    ...
    <td class="style3"><?php echo date("F d, Y", strtotime($amazonOrderModel->order_import_date)); ?></td>
  </tr>
    <tr>
  ...
  <tr>
  	<td><strong><?php echo Yii::t("invoice","Estimated Arrival Date");?> <?php if($showDoulCurrency):?> <?php endif;?>:</strong></td>
    <td class="style3">
	<?php echo date("F d, Y", strtotime($amazonOrderModel->latest_delivery_date)); ?></td>
  </tr>
   <tr>
	<td><strong><?php echo Yii::t("invoice","Shipment Date");?> <?php if($showDoulCurrency):?><?php endif;?>:</strong></td>
    <td ><?php echo date("F d, Y", strtotime($amazonOrderModel->latest_ship_date)); ?></td>
	</tr>
</table>
   ...
   <div class="section1">
	...
	<div class="right-colm">
	 ...
	 <div class="info">
	  ...
	  <p><strong><?php echo ($amazonOrderModel->customer_name!="")?ucfirst($amazonOrderModel->customer_name):ucfirst($amazonOrderModel->buyer_name);?></strong></p>
	   <p><?php echo ($amazonOrderModel->ship_address_1!="")?$amazonOrderModel->ship_address_1.' '.$amazonOrderModel->ship_address_2.' '.$amazonOrderModel->ship_address_3:$amazonOrderModel->address_2;?></p>
	    <p><?php echo ($amazonOrderModel->ship_postal_code!="")?$amazonOrderModel->ship_postal_code:$amazonOrderModel->postal_code ;?> <?php echo ($amazonOrderModel->ship_city!="")?$amazonOrderModel->ship_city:$amazonOrderModel->city;?></p>
		<!--<p><?php //echo $amazonOrderModel->state_or_region ;?></p> -->
		<p><?php echo ($amazonOrderModel->ship_country!="")?$amazonOrderModel->ship_country:$amazonOrderModel->country_code;?></p>		
	 </div>	
	</div>
   </div>
 <!--section1 end--> 
 ...
 <div class="section2">
  ...
  <?php
		...
		foreach($orderItems as $key=>$itemData ) { 
			/* $sellerSKU				= $amazonOrderModel->product_sku;
			$qty					= $amazonOrderModel->number_of_items_shipped;
			...
			$itemPrice				=  $amazonOrderModel->item_price;
			$itemGrossPrice			= (float)$itemPrice;
			...
			$itemCost				=  (float) ($amazonOrderModel->item_price/$qty);
			$netOrderAmount			= $itemPrice -$totalVat; 
			$itemPerQtyPrice		=  $netPrice/$qty; */
		...
		<tr>
			...
			<td style="vertical-align:middle;"><?php echo $currencySymbol;?> <?php echo number_format($itemPerQtyPrice,2);?><?php if($showDoulCurrency):?><p class="style1">lev <?php echo number_format($itemPerQtyPrice*$lvlConverPrice,2);?></p><?php endif;?></td>
			<td style="vertical-align:middle;"><?php echo $currencySymbol;?> <?php echo number_format($netPrice,2);?><?php if($showDoulCurrency):?><p class="style1">lev <?php echo number_format($netPrice*$lvlConverPrice,2);?></p><?php endif;?></td>			
		</tr>
	<?php } ?>
...
<div class="section3">
 ...
 <div class="right-colm">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <?php  $shippingPrice = $amazonOrderModel->shipping_price; ?>

  <tr>
    <th <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>>&nbsp;</th>
    <th><?php echo $amazonOrderModel->order_currency;?></th>	
	<?php if($showDoulCurrency):?><th>LEV</th><?php endif;?>
  </tr>

    <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","Subtotal");?><?php if($showDoulCurrency):?> / Дан. Осн <?php endif;?></td>
    <td ><?php 
   ...
   <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","VAT Amount");?> <?php if($showDoulCurrency):?> / ДДС <?php endif;?> <?php echo ($vatPer >0)?$vatPer:0;?>%</td>
   ...
   <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","Shipment Fees");?> <?php if($showDoulCurrency):?> <?php endif;?></td>
    <td><?php echo number_format($shippingPrice,2);?></td>
	<?php if($showDoulCurrency):?><td style="border-left:1px solid #ccc;"><?php echo number_format($shippingPrice*$lvlConverPrice,2);?></td><?php endif;?>

  </tr>
	 <?php $orderTotal =$orderTotal+$shippingPrice; ?>
      <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","Discount");?> <?php if($showDoulCurrency):?> / отстъпка <?php endif;?></td>
	...
	<?php if($showDoulCurrency):?><td style="border-left:1px solid #ccc;">-<?php echo number_format($discountAmount*$lvlConverPrice,2);?></td><?php endif;?>
      ...
      <tr>
    <td style="text-align:left;" <?php if(!$showDoulCurrency):?>colspan='2'<?php endif;?>><?php echo Yii::t("invoice","Net Amount");?><?php if($showDoulCurrency):?> / Сума нето <?php endif;?></td>
    <td><?php	$orderTotal = $orderTotal -$discountAmount;
	$netAmountAfterDiscount = $netOrderAmount -$discountAmount;
	echo number_format($netAmountAfterDiscount,2);?></td>
	<?php if($showDoulCurrency):?><td style="border-left:1px solid #ccc;"><?php echo number_format($netAmountAfterDiscount*$lvlConverPrice,2);?></td><?php endif;?>   
  </tr>

    <tr>
    <td colspan="3" class="total"><?php echo Yii::t("invoice","Total to pay");?><?php if($showDoulCurrency):?> / Сума нето <?php endif;?></td>
  </tr>
   <tr style="">
