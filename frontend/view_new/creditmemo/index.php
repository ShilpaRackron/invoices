    ...
    <?= GridView::widget([
       ...
       // 'filterModel' => $searchModel,
        'columns' => [
            ...
            ['class' => 'yii\grid\ActionColumn','template'=>'{view}&nbsp;{sendpdf}', 'buttons' => [
...
[ 'title' => Yii::t('app', 'View'), 'class'=>'', ]) ;
					...
					return 	Html::a('<span class="fas fa-file-pdf" title="Send PDF"></span>','#', ['class'=>'', 'title' => Yii::t('yii', 'Close'), 'onclick'=>" $.ajax({
					type     :'POST',
					cache    : false,
					data:{is_ajax: true },
					url  : '".$url."',
