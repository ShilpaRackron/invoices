		...
		<div id="sidebar-nav" class="sidebar">
			...
			<nav>
					<ul class="nav">
						...
						<li><a href="<?php echo Yii::$app->getUrlManager ()->createAbsoluteUrl ( ['user/manage-inventory'], true );?>" class=""><i class="fa fa-barcode"></i> <span>Inventory Data</span></a></li>

						<li><a href="<?php echo Yii::$app->getUrlManager ()->createAbsoluteUrl ( ['amazon-inventory-adjustment/index'], true );?>" class=""><i class="fa fa-barcode"></i> <span>Inventory Adjustment</span></a></li>

						<li><a href="<?php echo Yii::$app->getUrlManager ()->createAbsoluteUrl ( ['refund-requests/index'], true );?>" class=""><i class="fa fa-barcode"></i> <span>Refund Requests</span></a></li>

						<li><a href="<?php echo Yii::$app->getUrlManager ()->createAbsoluteUrl ( ['amazon-reimbursements/index'], true );?>" class=""><i class="fa fa-barcode"></i> <span>Reimbursements</span></a></li>
